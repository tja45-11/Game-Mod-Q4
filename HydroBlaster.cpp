...
class rvWeaponHydroBlaster : public rvWeapon {
public:

	CLASS_PROTOTYPE(rvWeaponHydroBlaster);

	rvWeaponHydroBlaster(void);
...
private:
	...
	CLASS_STATES_PROTOTYPE(rvWeaponHydroBlaster);
};

CLASS_DECLARATION(rvWeapon, rvWeaponHydroBlaster)
END_CLASS

/*
================
rvWeaponHydroBlaster::rvWeaponHydroBlaster
================
*/
rvWeaponHydroBlaster::rvWeaponHydroBlaster(void) {
}

/*
================
rvWeaponHydroBlaster::UpdateFlashlight
================
*/
bool rvWeaponHydroBlaster::UpdateFlashlight(void) {
	if (!wsfl.flashlight) {
		return false;
	}
...
/*
================
rvWeaponHydroBlaster::Flashlight
================
*/
void rvWeaponHydroBlaster::Flashlight(bool on) {
	owner->Flashlight(on);
...
/*
================
rvWeaponHydroBlaster::UpdateAttack
================
*/
bool rvWeaponHydroBlaster::UpdateAttack(void) {
	// Clear fire forced
	if (fireForced) {
		if (!wsfl.attack) {
			fireForced = false;
...
/*
================
rvWeaponHdyroBlaster::Spawn
================
*/
void rvWeaponHydroBlaster::Spawn(void) {
...
/*
================
rvWeaponHydroBlaster::Save
================
*/
void rvWeaponHydroBlaster::Save(idSaveGame* savefile) const {
...
/*
================
rvWeaponHydroBlaster::Restore
================
*/
void rvWeaponHydroBlaster::Restore(idRestoreGame* savefile) {
...
/*
================
rvWeaponHydroBlaster::PreSave
================
*/
void rvWeaponHydroBlaster::PreSave(void) {
...
/*
================
rvWeaponHydroBlaster::PostSave
================
*/
void rvWeaponHydroBlaster::PostSave(void) {
}
...
CLASS_STATES_DECLARATION(rvWeaponHydroBlaster)
STATE("Raise", rvWeaponHydroBlaster::State_Raise)
STATE("Lower", rvWeaponHydroBlaster::State_Lower)
STATE("Idle", rvWeaponHydroBlaster::State_Idle)
STATE("Charge", rvWeaponHydroBlaster::State_Charge)
STATE("Charged", rvWeaponHydroBlaster::State_Charged)
STATE("Fire", rvWeaponHydroBlaster::State_Fire)
STATE("Flashlight", rvWeaponHydroBlaster::State_Flashlight)
END_CLASS_STATES

/*
================
rvWeaponHydroBlaster::State_Raise
================
*/
stateResult_t rvWeaponHydroBlaster::State_Raise(const stateParms_t& parms) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};
...
/*
================
rvWeaponHydroBlaster::State_Lower
================
*/
stateResult_t rvWeaponHydroBlaster::State_Lower(const stateParms_t& parms) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
rvWeaponHydroBlaster::State_Idle
================
*/
stateResult_t rvWeaponHydroBlaster::State_Idle(const stateParms_t& parms) {
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};
...
/*
================
rvWeaponHydroBlaster::State_Charge
================
*/
stateResult_t rvWeaponHydroBlaster::State_Charge(const stateParms_t& parms) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};
...
/*
================
rvWeaponHydroBlaster::State_Charged
================
*/
stateResult_t rvWeaponHydroBlaster::State_Charged(const stateParms_t& parms) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};
...
/*
================
rvWeaponHydroBlaster::State_Fire
================
*/
stateResult_t rvWeaponHydroBlaster::State_Fire(const stateParms_t& parms) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};
...
/*
================
rvWeaponHydroBlaster::State_Flashlight
================
*/
stateResult_t rvWeaponHydroBlaster::State_Flashlight(const stateParms_t& parms) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};
